...
public class LightsTests {
    ...
    public void sphereMultiLight() {
        scene1.geometries.add(sphere);
        scene1._lights.add(new DirectionalLight(new Color(500, 300, 0), new Vector(1, 1, -1)));
        scene1._lights.add(  new PointLight(new Color(500, 300, 0), new Point3D(750,-50,780)) .setKl(0.00001) .setKq(0.0000001));
        scene1._lights.add(new SpotLight(new Color(700, 300, 700), new Point3D(-20, -30, 30),
    ...
    public void triangleMultiLight() {
        scene2.geometries.add(triangle1.setMaterial(new Material().setKd(0.5).setKs(0.5).setShininess(300)),
                triangle2.setMaterial(new Material().setKd(0.5).setKs(0.5).setShininess(300)));
        scene2._lights.add(new DirectionalLight(new Color(200, 100, 100), new Vector(0,0,-2)));
        scene2._lights.add(  new PointLight(new Color(500, 250, 250), new Point3D(20,-30,-130)) .setKl(0.0005) .setKq(0.0001));
        scene2._lights.add(new SpotLight(new Color(500,500,250), new Point3D(70,50,-130),
